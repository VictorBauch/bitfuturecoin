...
public:
    CMainParams() {
        ...
        //
        // CBlock(hash=000000000019d6, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=4a5e1e, nTime=1539626682, nBits=1d00ffff, nNonce=0, vtx=1)
...
public:
    CTestNetParams() {
        ...
        pchMessageStart[3] = 0x99;
        vAlertPubKey = ParseHex("04bc5735dcedee4f7a60253c8767fb15733217bc58198dd69b07574113d6cb9001394eaaaeaed30673cae63cbe580753bf88f3263521060205925e8f64458fde34");
        nDefaultPort = 52899;
        nRPCPort = 52900;
        strDataDir = "testnet3";
